...
// ── graph view (default) ──
{
  ...
  ok(cap.desc.props.transparent === true, 'widget props.transparent = true (frameless on canvas)')
  ok(typeof cap.desc.slot === 'string' || (cap.desc.x != null && cap.desc.y != null), 'widget is placed (slot or parked coords)')
