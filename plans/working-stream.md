...
- **Remaining:** #54 (.app-style folder whose subitems render ON the canvas — distinct from the collapsed real folder). Everything is GUI-pending on the user's Mac (no display here) and LOCAL — user pushes (HEAD `fc1d536`).
