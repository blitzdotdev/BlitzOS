...
- **Remaining backlog:** #45 review-fold + commit → #51 substrate (build) → #52 persisted/.app folders → #53 persist-consent → add the missing workspace-roundtrip/security regression tests. All commits LOCAL (user pushes): HEAD `e078aef` + uncommitted #45 steps 2–4.
