...
/**
 * One subject as a mark: a rounded square for a workspace, a tinted circle
 * for a member, the accent circle for everyone in the org.
 *
...
export function AccessFace({
  ...
  return (
    <span
      ...
      style={subject.subjectKind === 'membership'
