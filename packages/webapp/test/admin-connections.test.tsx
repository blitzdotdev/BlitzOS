...
function client(overrides: Partial<ControlPlaneClient> = {}): ControlPlaneClient {
  return {
    ...
    createWorkspaceSession: vi.fn(async (_id, input) => ({ session: {
      ...
      terminalKey: 'session', chatSessionId: null, chatProvider: null, revision: 1, createdAt: 1, updatedAt: 1,
    } })),
    ...
    getPresence: vi.fn(async () => ({ serverTime: 1, expiresAfterMs: 35_000, truncated: false, members: [] })),
