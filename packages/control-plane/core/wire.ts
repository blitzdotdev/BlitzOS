...
// The box-config vocabulary lives in its own module and is re-exported here,
// so `wire-machines.ts` can name `BoxUpdateOutcome` without importing back
// through this file. See `core/wire-box-config.ts`.
export {
  BOX_UPDATE_OUTCOMES,
  type BoxConfigResponse,
  type BoxUpdateOutcome,
  type BoxUpdateResultRequest,
} from "./wire-box-config.js";
