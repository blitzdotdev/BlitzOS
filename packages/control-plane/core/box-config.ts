...
export function addBoxConfigRoutes(
  ...
  // The in-box updater's last verdict. This is an idempotent projection onto
  // the machine row: retrying the same report creates nothing and returns the
  // same success, while refreshing when the plane last heard it.
