...
export const CORE_MANIFEST = Object.freeze([
  ...
  "core/volumes.ts",
  "core/preview.ts",
  "core/webapp-state.ts", "core/webapp-proxy.ts", "core/webapp-surface.ts", "core/webapp-tickets.ts", "core/workspace-sessions.ts",
...
export const BLITZDEV_CONFIG = Object.freeze({
  ...
  tables: [
    ...
    },
    {
      ...
      fields: [
        { name: "id", type: "text", sqlType: "text", primary: true, noUpdate: true, usage: "record_uid" },
        { name: "workspace_id", type: "text", sqlType: "text", notNull: true, foreignKey: { table: "workspaces", column: "id", onDelete: "CASCADE" } },
        { name: "kind", type: "text", sqlType: "text", notNull: true, check: "kind IN ('claude', 'codex', 'opencode', 'pi', 'kimi', 'prime', 'terminal', 'chat')" },
        { name: "title", type: "text", sqlType: "text" },
        { name: "metadata_json", type: "json", sqlType: "text", notNull: true, default: { l: "{}" } },
        { name: "created_by_membership_id", type: "text", sqlType: "text", foreignKey: { table: "memberships", column: "id", onDelete: "SET NULL" } },
        { name: "revision", type: "integer", sqlType: "integer", notNull: true, default: { l: 1 }, check: "revision > 0" },
        { name: "created_at", type: "integer", sqlType: "integer", notNull: true },
        { name: "updated_at", type: "integer", sqlType: "integer", notNull: true },
        { name: "archived_at", type: "integer", sqlType: "integer" },
      ],
      indexes: [{ name: "workspace", fields: ["workspace_id", "archived_at", "created_at", "id"] }],
      extensions: [DENY_ALL_RULES],
    },
    {
      name: "workspace_member_views",
      fields: [
        { name: "workspace_id", type: "text", sqlType: "text", notNull: true, foreignKey: { table: "workspaces", column: "id", onDelete: "CASCADE" } },
