...
export const API_PREFIXES = Object.freeze([
  "/sessions", "/workspaces", "/workspace-templates", "/workspace-recipes", "/hooks/", "/trigger-events/", "/agent-rules", "/folders", "/volumes", "/machine-types", "/webapp-state",
...
function isApiPath(pathname: string): boolean {
  return /^\\/recipes\\/[^/]+\\/fire-token$/u.test(pathname)
    || API_PREFIXES.some((prefix) => pathname === (prefix.endsWith("/") ? prefix.slice(0, -1) : prefix) || pathname.startsWith(prefix));
}
