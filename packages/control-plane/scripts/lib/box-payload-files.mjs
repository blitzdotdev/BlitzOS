...
export const PAYLOAD_ROOTFS_PATHS = Object.freeze([
  ...
  "etc/s6-overlay/s6-rc.d/box-credential/dependencies.d/init-state",
  ...
  "etc/s6-overlay/s6-rc.d/dockerd/dependencies.d/init-state",
  "etc/s6-overlay/s6-rc.d/dockerd/run",
  "etc/s6-overlay/s6-rc.d/dockerd/type",
  "etc/s6-overlay/s6-rc.d/dufs/dependencies.d/init-state",
  ...
  "etc/s6-overlay/s6-rc.d/lody-daemon/dependencies.d/init-state",
  ...
  "etc/s6-overlay/s6-rc.d/remote-control/dependencies.d/init-state",
  "etc/s6-overlay/s6-rc.d/remote-control/run",
  "etc/s6-overlay/s6-rc.d/remote-control/type",
  "etc/s6-overlay/s6-rc.d/rules/dependencies.d/init-state",
  "etc/s6-overlay/s6-rc.d/rules/type",
  "etc/s6-overlay/s6-rc.d/rules/up",
  "etc/s6-overlay/s6-rc.d/sshd/dependencies.d/init-state",
  "etc/s6-overlay/s6-rc.d/sshd/run",
  "etc/s6-overlay/s6-rc.d/sshd/type",
  "etc/s6-overlay/s6-rc.d/ttyd/dependencies.d/init-state",
