...
function ProfilePanel({
  ...
  return (
    <section className="settings-panel" role="tabpanel" aria-label="Profile">
      ...
      />
      {signOutFailed && (
        <p className="cockpit-form-message" role="alert">Could not sign out. Try again.</p>
      )}
...
export function SettingsHeader({
  ...
  return (
    <header className="settings-header">
      <button className="settings-back" type="button" onClick={onBack}>← <span>{workspaceLabel || 'Cockpit'}</span></button>
